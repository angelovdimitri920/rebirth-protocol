...
| **I2** | Trajectory bombs | The `BombSystem` half of Task I: extreme vertical arc, curving trajectory, dwelling mines → **Steeplefall, Oxbow Charge (D/S), Oubliette Mine, Oubliette Twin** | ARMORY §6 |
