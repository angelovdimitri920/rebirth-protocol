...
|---|---|---|---|
| **B** | Shield toll & raise behaviors | `ShieldPart` toll + Root/March/Air-hold/Air-drop; toll UI like the bomb's; new shields **Targe, Kite Ward, Quiet Bell** | ARMORY §2.3–2.4, §7 |
